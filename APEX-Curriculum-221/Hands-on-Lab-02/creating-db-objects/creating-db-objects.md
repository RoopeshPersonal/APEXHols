...
To manage items in the cart, you will use [collections](https://docs.oracle.com/en/database/oracle/application-express/21.2/aeapi/APEX_COLLECTION.html), which enable you to temporarily store products currently in session state so they can be accessed, manipulated, or processed during a user's specific session.
...
2. Navigate to the + button on the right side, and click **Package**.
    ...
    ![](./images/create-package1.png " ")

3. Select **Specification** and click **Next**.

    ![](./images/create-package-specification4.png " ")

4. For Package Name, enter **MANAGE_ORDERS** and click **Next**.

    ![](./images/create-package-name1.png " ")
...
6. Click **Create Package Specification**.
    ...
    ![](./images/create-package-specification2.png " ")
...
8. Click **Save & Compile**.
    ...
    ![](./images/create-package-body2.png " ")
